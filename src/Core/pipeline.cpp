...
void Pipeline::createGraphicsPipeline(const std::string& vert, const std::string& frag, const PipelineConfigInfo& configInfo) {
    ...
    pipelineInfo.basePipelineIndex = -1; //Used for multiple pipelines, where one drives off another. Useful for performance but currently unnecessary
...
//Creating shader module from code for vertex/frag shaders
...
PipelineConfigInfo Pipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
    ...
    //Default Viewport Settings -- No longer needed since we are using a dynamic viewport
    /*
    ...
    */
    ...
    //Default Rasterization Settings
    configInfo.rasterizationInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO;
    configInfo.rasterizationInfo.depthClampEnable = VK_FALSE;
    configInfo.rasterizationInfo.rasterizerDiscardEnable = VK_FALSE;
    configInfo.rasterizationInfo.polygonMode = VK_POLYGON_MODE_FILL;
    configInfo.rasterizationInfo.lineWidth = 1.0f;
    configInfo.rasterizationInfo.cullMode = VK_CULL_MODE_NONE;          //Culling Settings - Use for Backface Culling
    configInfo.rasterizationInfo.frontFace = VK_FRONT_FACE_CLOCKWISE;   //Culling Winding Order, used to see which side of triangle we are seeing
    configInfo.rasterizationInfo.depthBiasEnable = VK_FALSE;
    configInfo.rasterizationInfo.depthBiasConstantFactor = 0.0f;  // Optional
    configInfo.rasterizationInfo.depthBiasClamp = 0.0f;           // Optional
    configInfo.rasterizationInfo.depthBiasSlopeFactor = 0.0f;     // Optional

    //Default Multisampling Settings (Modify for MSAA)
    ...
    //Default Colour Blending Settings
    ...
    //Default Depth Stencil Settings
